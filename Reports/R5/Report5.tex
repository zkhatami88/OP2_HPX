...
op_par_loop_adt_calc("adt_calc",cells,
  op_arg_dat(p_x,0,OP_ID,2,"double",OP_READ),
  op_arg_dat(p_x,1,OP_ID,2,"double",OP_READ),
  op_arg_dat(p_x,2,OP_ID,2,"double",OP_READ),
  op_arg_dat(p_x,3,OP_ID,2,"double",OP_READ),
  op_arg_dat(p_q,-1,OP_ID,4,"double",OP_READ),
