...
void work(int start, int finish, op_arg arg0, op_arg arg1) 
{
        for(int n=start; n<finish; n++)
		save_soln(&((double*)arg0.data)[4*n],&((double*)arg1.data)[4*n]);
}
...
std::vector<hpx::future<void>> op_par_loop_save_soln(char const *name, op_set set,
  ...
  if (set->size >0) {
	...
	new_data.push_back(hpx::async(work,start,finish,arg0,arg1));
    }
  }
