...
// host stub function
hpx::shared_future<op_dat> op_par_loop_update2(char const * name, op_set set,
  ...
  return dataflow(hpx::launch::async,unwrapped([&name,set,arg4](op_arg arg0, op_arg arg1, op_arg arg2, op_arg arg3){
  ...
  if (set->size >0) {
    ...
    hpx::parallel::for_each(hpx::parallel::par.with(dcs),r.begin(), r.end(),[set,arg0,arg1,arg2,arg3,&arg4_l,nthreads](std::size_t thr){
