...
// host stub function
hpx::shared_future<op_dat> op_par_loop_save_soln(char const * name, op_set set,
  ...
  hpx::future<op_arg> arg1)
{
  ...
  return dataflow(hpx::launch::async,unwrapped([&name,set](op_arg arg0, op_arg arg1){
  ...
  if (set->size >0) {
    ...
    hpx::parallel::for_each(hpx::parallel::par.with(dcs),r.begin(), r.end(),[set,arg0,arg1,nthreads](std::size_t thr){
