...
// host stub function
hpx::shared_future<op_dat> op_par_loop_bres_calc(char const * name, op_set set,
  ...
  hpx::parallel::dynamic_chunk_size dcs(64);
     ...
     hpx::parallel::for_each(hpx::parallel::par.with(dcs),r.begin(), r.end(),[args,&Plan,block_offset](std::size_t blockIdx){
      ...
      for ( int n=offset_b; n<offset_b+nelem; n++ ){
        ...
        bres_calc(
          ...
          &((double*)args[3].data)[1 * map2idx],
          &((double*)args[4].data)[4 * map2idx],
          &((int*)args[5].data)[1 * n]);
      }
