...
// host stub function
hpx::future<void> op_par_loop_update(char const *name, hpx::future<op_set> set,
  ...
  return dataflow(unwrapped([&name](op_set set, op_arg arg0, op_arg arg1, op_arg arg2, op_arg arg3, op_arg arg4){
